        ...
        <div class="row">
            ...
            <div class="col-md-2 bootstrap-admin-col-left">
                <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
                     <li>
                        <a href="/books/admin_book.jsp"><i class="glyphicon glyphicon-chevron-right"></i>档案管理</a>
                    </li>
                    <li>
                        <a href="/books/admin_user.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 档案人员管理</a>
                    </li>
                    <li>
                        <a href="/books/admin_booktype.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 档案分类管理</a>
                    </li>
                    <li>
                        <a href="/books/admin_borrow.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 档案借阅信息</a>
                    </li>
                    <li>
                        <a href="/books/admin_history.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 档案归还信息</a>
                    </li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">档案借阅信息</div>
                            </div>
...
id="btn_update" onclick="haibook(<%= bean.getHid() %>)">归档</button>
	</td>                                            
                          	  </tbody>
                       <%} %> 
                        </table>
										...
										<!---------------------表单-------------------->
										 ...
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">档案名称</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updateBookName" name="name"  placeholder="请输入档案名称">
										...
										<!---------------------表单-------------------->
										 ...
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">分类名称</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addBookName" required="required" name="name"  placeholder="请输入档案名称">
