        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="collapse navbar-collapse main-navbar-collapse">
                    <a class="navbar-brand" href="/reader.jsp"><strong>欢迎使用档案馆管理系统</strong></a>
    ...
    <div class="row">
        ...
        <div class="col-md-2 bootstrap-admin-col-left">
            <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
                <li>
                    <a href="/books/select.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 档案查询</a>
                </li>
	            <li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">档案查询</div>
                        </div>
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                <li>根据档案编号、档案名称查询档案信息</li>
                                <li>可查询档案的编号、名称、分类、作者、价格、在馆数量等</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                <li>可查询除档案的基本信息、借阅日期、截止档案归还日期、超期天数等</li>
                            </ul>
                        </div>
                    </div>
                </div>
